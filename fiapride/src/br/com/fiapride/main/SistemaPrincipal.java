...
public class SistemaPrincipal {
    ...
    public static void main(String[] args) {
        ...
        Veiculo carro = new Veiculo("ABC-1234", "Toyota Corolla", "Carro", 3);
        ...
        // Leitura agora é SÓ via getters:
        ...
        // Teste de invasão — descomente e tente compilar:
        // passageiro1.saldo = 999999.0;
        // Resultado: error: saldo has private access in Passageiro
        // Compile time. Nem gera .class. A proteção é do compilador, não da IDE.
    }
}
